...
export const PRODUCTS = [
  ...
  },
 {
  ...
  {
    id: 39,
    slug: "vasanti-amenity-set",
    name: "Vasanti Amenity Set",
    category: "Comfort Items",
    categorySlug: "comfort-items",
    image: "/images/vasanti-amenity-set.jpg",
    description: "Set amenity premium Vasanti — slipper putih elegan dengan bordir emas, dental kit, toothbrush kit, sanitary bag, dan shower cap dalam packaging hitam eksklusif.",
    gallery: [],
  },
  {
    id: 40,
    slug: "eco-linen-amenity-set",
    name: "Eco Linen Amenity Set",
    category: "Eco Material",
    categorySlug: "eco-material",
    image: "/images/eco-linen-amenity-set.jpg",
    description: "Set amenity eco-friendly lengkap — linen slipper, cotton buds, shower cap, bamboo comb, wooden shaving kit, sewing kit, loofah, dan bamboo dental kit dalam packaging kraft natural.",
    gallery: [],
  },
  {
    id: 41,
    slug: "luxury-navy-gold-amenity-set",
    name: "Luxury Navy Gold Amenity Set",
    category: "Comfort Items",
    categorySlug: "comfort-items",
    image: "/images/luxury-navy-gold-amenity-set.jpg",
    description: "Set amenity mewah navy & gold — plush slipper, dental kit, comb, vanity kit, sewing kit, dan body lotion dalam packaging navy premium dengan aksen emas.",
    gallery: [],
  },
  {
    id: 42,
    slug: "aibeni-navy-amenity-set",
    name: "Aibeni Navy Amenity Set",
    category: "Comfort Items",
    categorySlug: "comfort-items",
    image: "/images/aibeni-navy-amenity-set.jpg",
    description: "Set amenity Aibeni eksklusif — slipper navy premium, dental kit, toothbrush kit, sanitary bag, dan shower cap dalam packaging navy dengan aksen copper yang elegan.",
    gallery: [],
  },
];
